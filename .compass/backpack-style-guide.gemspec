...
require './lib/backpack-style-guide.rb'
...
Gem::Specification.new do |s|
  ...
  s.name = "backpack-style-guide"
  s.rubyforge_project = "backpack-style-guide"
  # Description of your extension
  s.description = %q{Backpack Style Guide}
  # A summary of your Compass extension. Should be different than Description
  s.summary = %q{Full style guide and component guide for Backpack}
  # The names of the author(s) of the extension.
  # If more than one author, comma separate inside of the brackets
  s.authors = ["Benoit Deziel"]
  # The email address(es) of the author(s)
  # If more than one author, comma separate inside of the brackets
  s.email = ["ben@benoitdeziel.com"]
  # URL of the extension
  s.homepage = "backpack.com"
  # License
  ...
  # Library Files
  s.files += Dir.glob("lib/backpack-style-guide.rb")
