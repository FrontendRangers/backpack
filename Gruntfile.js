...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      ext: {
        ...
        files: {
          '.compass/lib/backpack-style-guide.rb': ['.compass/.template/backpack-style-guide.rb']
        }
      }
    },
    ...
    exec: {
      ...
      ext: {
        cmd: 'cd .compass && gem build backpack-style-guide.gemspec && mv backpack-style-guide-' + userConfig.client.version + '.gem ../backpack-style-guide-' + userConfig.client.version + '.gem && cd ..'
      },
      install: {
        cmd: 'gem install backpack-style-guide-' + userConfig.client.version + '.gem && rm backpack-style-guide-' + userConfig.client.version + '.gem'
      }
    },
  ...
  grunt.registerTask('extension', 'Build your Compass Extension', function() {
    ...
    gemfile += "\ngem 'backpack-style-guide', '~>" + grunt.userConfig.client.version + "'";
